...
export const marketsData: {
  ...
  [CustomMarket.piccadilly]: {
    ...
    addresses: {
      ...
      LENDING_POOL: "0x31E2E7ff5060b29f834A8Deb479A4DB3ceC076ec",
      WETH_GATEWAY: "0x51D8d70C7f43AC8cBdAB2E74699958Bc40c32eD6",
      // SWAP_COLLATERAL_ADAPTER: AaveV2Avalanche.SWAP_COLLATERAL_ADAPTER,
      // REPAY_WITH_COLLATERAL_ADAPTER: AaveV2Avalanche.REPAY_WITH_COLLATERAL_ADAPTER,
      WALLET_BALANCE_PROVIDER: "0x24dCa602f79878b1d6b843F3726c7Fe1603bd74f",
      UI_POOL_DATA_PROVIDER: "0xb66248Cf0Aa5901b7a42410B04596DBC74D7C2f1",
      UI_INCENTIVE_DATA_PROVIDER: "0x7A07Cb38dF66EFd75F3230b6B8bee0D43Ed118D6",
      // COLLECTOR: AaveV2Avalanche.COLLECTOR,
      // V3_MIGRATOR: AaveV2Avalanche.MIGRATION_HELPER,
      // DEBT_SWITCH_ADAPTER: AaveV2Avalanche.DEBT_SWAP_ADAPTER,
    },
  },
  [CustomMarket.holesky]: {
    marketTitle: 'Holesky',
    market: CustomMarket.holesky,
    chainId: 17000,
    // enabledFeatures: {
    //   liquiditySwap: true,
    //   incentives: true,
